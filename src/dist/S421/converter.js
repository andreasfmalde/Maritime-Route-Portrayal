...
import { parseXML, getCoordinates } from "../utility.js";
...
function generateS421RouteWaypoint(object){
...
function generateS421RouteWaypointLeg(object){
...
function S421RouteActionpointToGeoJSON(object){
    const id = object._attributes.id;
